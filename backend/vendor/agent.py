...
# Alias ChatOpenAI to our CrewAI adapter to replace langchain_openai
ChatOpenAI = CrewAILLMAdapter

# Stub out removed LangChain helpers to avoid NameError
def format_log_to_str(log):
    """Stub: return string representation of intermediate steps."""
    return str(log)

class ReActSingleInputOutputParser:
    """Stub parser to replace LangChain's ReActSingleInputOutputParser."""
    def __init__(self):
        pass
...
class ConversationSummaryMemory:
    """Stub memory to replace LangChain's ConversationSummaryMemory."""
    def __init__(self, llm, input_key: str, memory_key: str):
        pass
